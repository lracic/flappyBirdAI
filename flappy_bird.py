...
def main(genomes, config):
    ...
    for _, g in genomes:
        ...
        nets.append(net)
        birds.append(Bird(random.randint(190, 250), random.randint(320, 380)))
        g.fitness = 0
        ge.append(g)
    ...
    while run:
        ...
        if add_pipe:
            ...
            for g in ge:
                g.fitness += 5
            pipes.append(Pipe(random.randint(480, 600)))
